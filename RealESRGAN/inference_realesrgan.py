...
def infer_RESRGAN(input_path,
    ...
    parser.add_argument('-s', '--outscale', type=float, default=outscale, help='The final upsampling scale of the image')
    parser.add_argument(
        '--model_path', type=str, default=model_path, help='[Option] Model path. Usually, you do not need to specify it')
    ...
    for idx, path in enumerate(tqdm(paths),desc="Enhencing image"):
...
if __name__ == '__main__':
    infer_RESRGAN(input_path='inputs', model_name='RealESRGAN_x4plus', output_path='results',
    denoise_strength=0.5,outscale=4, gpu_id=0)
